...
#Exchange Online
Connect-ExchangeOnline -CertificateThumbprint $Thumbprint -AppId $AppId -ShowBanner:$false -Organization $Organization  -ExchangeEnvironmentName O365USGovGCCHigh 

#Connect to Graph
Connect-Graph -TenantId $Tenantid -AppId  $AppId -CertificateThumbprint $Thumbprint -Environment USGov
